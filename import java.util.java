...
public class Gudang {
    public static void main(String[] args) {
        ...
        String login, username, password, namabarang, kode, quantity, lokasi, next;
...
//Update Data Barang
        ...
        System.out.printf("%-15s %-15s %-15s %-15s", barang[kodeUpdate][0], barang[kodeUpdate][1], barang[kodeUpdate][2], barang[kodeUpdate][3]);
        } else {
